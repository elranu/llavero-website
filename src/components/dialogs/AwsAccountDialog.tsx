    ...
    <Dialog open={isOpen} onOpenChange={onOpenChange}>
      ...
      <DialogContent className={'lg:max-w-screen-lg overflow-y-auto max-h-[90vh]'}>
        ...
        <div className='flex flex-col gap-8'>
          ...
          <div>
            <h3 className='mb-2 font-bold'>1. Click on Sign In to the Console</h3>
            <img
          ...
          <div>
            <h3 className='mb-2 font-bold'>2. Click on Create a new AWS account</h3>
            <img
          ...
          <div>
            <h3 className='mb-2 font-bold'>5. Type a strong password</h3>
            <img
          ...
          <div>
            <h3 className='mb-2 font-bold'>6. Fill you contact information</h3>
            <img
...
Then continue to step 2.'
          ...
          <div>
            <h3 className='mb-2 font-bold'>11. Click on Select a support plan</h3>
            <img
          ...
          <div>
            <h3 className='mb-2 font-bold'>12. Click on Complete sign up</h3>
            <img
          ...
          <div>
            <h3 className='mb-2 font-bold'>13. Click on Go to the AWS Management Console</h3>
            <img
